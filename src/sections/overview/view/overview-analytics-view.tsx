...
import { Bot, Send, Star, Clock, Inbox, TrendingUp, ChevronLeft, ChevronRight, MoreVertical } from 'lucide-react';
...
// Guest data
const guestData = [
  { id: '1', name: 'John Smith', status: 'Checking out', checkIn: 'Oct 25', checkOut: 'Oct 27', statusColor: 'success', hasCheckedOut: false },
  { id: '2', name: 'Sarah Johnson', status: 'Checking out', checkIn: 'Oct 25', checkOut: 'Oct 27', statusColor: 'success', hasCheckedOut: false },
  { id: '3', name: 'Mike Wilson', status: 'Checking out', checkIn: 'Oct 25', checkOut: 'Oct 27', statusColor: 'success', hasCheckedOut: false },
  { id: '4', name: 'Emily Davis', status: 'Arriving', checkIn: 'Oct 27', checkOut: 'Oct 29', statusColor: 'info', hasCheckedOut: false },
  { id: '5', name: 'David Brown', status: 'Arriving', checkIn: 'Oct 27', checkOut: 'Oct 29', statusColor: 'info', hasCheckedOut: false },
  { id: '6', name: 'Lisa Anderson', status: 'Checked out', checkIn: 'Oct 20', checkOut: 'Oct 24', statusColor: 'default', hasCheckedOut: true },
  { id: '7', name: 'Robert Taylor', status: 'Checked out', checkIn: 'Oct 18', checkOut: 'Oct 22', statusColor: 'default', hasCheckedOut: true },
  { id: '8', name: 'Jennifer White', status: 'Checked out', checkIn: 'Oct 15', checkOut: 'Oct 19', statusColor: 'default', hasCheckedOut: true },
  { id: '9', name: 'Michael Garcia', status: 'Checked out', checkIn: 'Oct 12', checkOut: 'Oct 16', statusColor: 'default', hasCheckedOut: true },
  { id: '10', name: 'Amanda Martinez', status: 'Checked out', checkIn: 'Oct 10', checkOut: 'Oct 14', statusColor: 'default', hasCheckedOut: true },
  { id: '11', name: 'Christopher Lee', status: 'Checked out', checkIn: 'Oct 8', checkOut: 'Oct 12', statusColor: 'default', hasCheckedOut: true },
  { id: '12', name: 'Jessica Thompson', status: 'Checked out', checkIn: 'Oct 5', checkOut: 'Oct 9', statusColor: 'default', hasCheckedOut: true },
];
  ...
  const featuredApps = [
    {
      ...
      description: "The aroma of freshly brewed coffee filled the air as Sarah sat down at her home office desk, ready to tackle another day of remote work.",
    ...
    },
    {
      ...
      description: "The children giggled with joy as they ran through the colorful playground, their laughter echoing across the park.",
      category: "FEATURED APP",
    ...
    },
    {
      ...
      description: "Discover the core concepts of machine learning and artificial intelligence in this comprehensive guide.",
      category: "FEATURED APP",
    ...
    <DashboardContent maxWidth="xl">
            ...
            <CardContent sx={{ p: 3, position: 'relative', zIndex: 1, height: '100%', display: 'flex', flexDirection: 'column', justifyContent: 'space-between' }}>
              <Box sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start',  }}>
                <Box sx={{ flex: 1 }}>
                  ...
                  <Typography variant="body2" sx={{ opacity: 0.9, maxWidth: 250, lineHeight: 1.5, fontSize: '0.9rem' }}>
                ...
                <Box sx={{ ml: 2, flexShrink: 0 }}>
                  ...
                  >
                    ...
                    <defs><filter id="filter0_f_1_51" width="101.56" height="100.65" x="232.807" y="109.722" colorInterpolationFilters="sRGB" filterUnits="userSpaceOnUse"><feFlood floodOpacity="0" result="BackgroundImageFix" /><feBlend in="SourceGraphic" in2="BackgroundImageFix" result="shape" /><feGaussianBlur result="effect1_foregroundBlur_1_51" stdDeviation="10" /></filter><linearGradient id="paint0_linear_1_51" x1="47.397" x2="47.397" y1="107.95" y2="281.395" gradientUnits="userSpaceOnUse"><stop stopColor="var(--primary-light)" /><stop offset="1" stopColor="var(--primary-dark)" /></linearGradient><linearGradient id="paint1_linear_1_51" x1="248.43" x2="248.43" y1="128.061" y2="169.533" gradientUnits="userSpaceOnUse"><stop stopColor="var(--primary-light)" /><stop offset="1" stopColor="var(--primary-dark)" /></linearGradient><linearGradient id="paint2_linear_1_51" x1="248.43" x2="248.43" y1="128.061" y2="169.533" gradientUnits="userSpaceOnUse"><stop stopColor="var(--primary-light)" /><stop offset="1" stopColor="var(--primary-dark)" /></linearGradient><linearGradient id="paint3_linear_1_51" x1="248.43" x2="248.43" y1="128.061" y2="169.533" gradientUnits="userSpaceOnUse"><stop stopColor="var(--primary-light)" /><stop offset="1" stopColor="var(--primary-dark)" /></linearGradient><linearGradient id="paint4_linear_1_51" x1="248.43" x2="248.43" y1="128.061" y2="169.533" gradientUnits="userSpaceOnUse"><stop stopColor="var(--primary-light)" /><stop offset="1" stopColor="var(--primary-dark)" /></linearGradient><linearGradient id="paint5_linear_1_51" x1="109.604" x2="109.604" y1="76" y2="104.047" gradientUnits="userSpaceOnUse"><stop stopColor="var(--primary-light)" /><stop offset="1" stopColor="var(--primary-dark)" /></linearGradient><linearGradient id="paint6_linear_1_51" x1="109.604" x2="109.604" y1="76" y2="104.047" gradientUnits="userSpaceOnUse"><stop stopColor="var(--primary-light)" /><stop offset="1" stopColor="var(--primary-dark)" /></linearGradient><linearGradient id="paint7_linear_1_51" x1="109.604" x2="109.604" y1="76" y2="104.047" gradientUnits="userSpaceOnUse"><stop stopColor="var(--primary-light)" /><stop offset="1" stopColor="var(--primary-dark)" /></linearGradient></defs>
                    <image href="https://pub-c5e31b5cdafb419fb247a8ac2e78df7a.r2.dev/public/assets/illustrations/characters/character-present.webp" height="280" x="320" y="40" />
                  </svg>
                </Box>
              </Box>
            ...
            <CardContent sx={{ p: 3, position: 'relative', zIndex: 1, height: '100%', display: 'flex', flexDirection: 'column', justifyContent: 'space-between' }}>
                  ...
                  {featuredApps.map((_, index) => (
                    <Box
                      ...
                      sx={{ 
                        ...
                        height: 8, 
                        borderRadius: '50%', 
                        backgroundColor: currentSlide === index ? '#4caf50' : 'rgba(255,255,255,0.3)',
                        cursor: 'pointer',
                        transition: 'all 0.3s ease',
                        '&:hover': {
                          backgroundColor: currentSlide === index ? '#4caf50' : 'rgba(255,255,255,0.5)',
                          transform: 'scale(1.2)'
                        }
                      }} 
                    />
              ...
              <Box sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-end' }}>
                ...
                <Box sx={{ flex: 1, maxWidth: '70%' }}>
                  ...
                  <Typography variant="h6" sx={{ mb: 1.5, fontWeight: 700, fontSize: '1.1rem', lineHeight: 1.2 }}>
      ...
      <Grid container spacing={3} sx={{ mb: 3 }}>
        {/* Left Card - Recent Reservations Table */}
          ...
          <Card sx={{ height: '100%', borderRadius: 2, boxShadow: '0 2px 8px rgba(0,0,0,0.1)', display: 'flex', flexDirection: 'column' }}>
            ...
            <CardContent sx={{ flex: 1, display: 'flex', flexDirection: 'column', p: 0 }}>
                    ...
                    <TableRow key={reservation.id}>
                      <TableCell>
                        <Box sx={{ display: 'flex', alignItems: 'center', gap: 2 }}>
                          <Avatar sx={{ width: 32, height: 32, backgroundColor: '#e3f2fd', color: '#1976d2', fontWeight: 600 }}>
              ...
              <Box sx={{ p: 2, borderTop: '1px solid #f0f0f0', display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                <Typography variant="body2" color="text.secondary">
                  Showing {startIndex + 1}-{Math.min(endIndex, guestData.length)} of {guestData.length} guests
                </Typography>
                <Pagination
                  count={totalPages}
                  page={guestPage}
            ...
            <CardContent>
              ...
              <Box sx={{ display: 'flex', flexDirection: 'column', gap: 2 }}>
                {(() => {
                  ...
                  const currentData = messageAnalyticsData[activeTab as keyof typeof messageAnalyticsData];
                  ...
                  <Box key={index} sx={{ display: 'flex', alignItems: 'center', gap: 2, p: 1 }}>
                    ...
                    <Box sx={{ display: 'flex', alignItems: 'center', gap: 0.5 }}>
                      ...
                      <Typography variant="caption" sx={{ color: metric.trendColor, fontWeight: 500 }}>
                        {metric.trend}
                      </Typography>
                    </Box>
                  </Box>
            ...
            <Card sx={{ 
              ...
              <CardContent sx={{ 
                ...
                <Box sx={{ textAlign: 'right', flex: 1, ml: 2 }}>
                  ...
                  <Typography variant="body1" sx={{ opacity: 0.9, fontSize: '1rem', fontWeight: 500 }}>
                    Guest Check-ins
                  </Typography>
                </Box>
        </CardContent>
