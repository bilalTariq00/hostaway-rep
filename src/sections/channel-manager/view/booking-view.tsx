    ...
    <DashboardContent maxWidth="xl">
            ...
            <TableBody>
              {mockBookingListings.map((listing) => (
                <TableRow key={listing.id} sx={{ '&:hover': { bgcolor: 'grey.50' } }}>
                  ...
                  <TableCell>{/* Multi-unit column - empty in reference */}</TableCell>
                  <TableCell>
                    <Button
                      size="small"
                      variant="outlined"
                  ...
                  <TableCell>
                    {listing.mapping ? (
                      ...
                      <Select size="small" value="" displayEmpty sx={{ minWidth: 120 }}>
                        <MenuItem value="">
                          <em>Select...</em>
                        </MenuItem>
          ...
          <Box sx={{ mt: 2 }}>
            <Box sx={{ display: 'flex', alignItems: 'flex-start', gap: 2, mb: 2 }}>
              ...
              <Typography variant="body2">
                When Booking.com is connected, all current Hostaway availability and rates will be
                uploaded and replace current Booking.com settings.
              </Typography>
            </Box>
            <Box sx={{ display: 'flex', alignItems: 'flex-start', gap: 2, mb: 2 }}>
              <img
            ...
            <Box sx={{ display: 'flex', alignItems: 'flex-start', gap: 2, mb: 2 }}>
              ...
              />
              <Typography variant="body2">
                When different currencies are used in Booking.com and Hostaway, I will immediately
                adjust the markup to reflect this to avoid bookings at low rates.
              </Typography>
            </Box>
            <Box sx={{ display: 'flex', alignItems: 'flex-start', gap: 2, mb: 2 }}>
              <img
              ...
              />
              <Typography variant="body2">
                Booking.com will manually activate my guest messaging connection with the Hostaway
                software. This may take a couple of weeks. Until then I will have to manage the
                guest messaging from the Booking.com platform.
              </Typography>
            </Box>
            <Box sx={{ display: 'flex', alignItems: 'flex-start', gap: 2, mb: 2 }}>
              <img
            ...
            <Box sx={{ display: 'flex', alignItems: 'flex-start', gap: 2, mb: 2 }}>
              ...
              />
              <Typography variant="body2">
                I am not using multi-room availability in my listings on Booking.com. My inventory
                has to consist of 1 room available per day per room type.
              </Typography>
            </Box>
          </Box>
      ...
      >
        <DialogTitle sx={{ pb: 1 }}>
          <Typography
            variant="h4"
            sx={{ fontWeight: 700, textAlign: 'start', mb: 2, color: '#333' }}
          >
        ...
        {selectedListing && (
          <>
            ...
            <Box sx={{ mb: 4 }}>
              ...
              <TextField fullWidth label="Min stay" value="1" sx={{ mb: 2 }} />
              <Button
                variant="contained"
                fullWidth
                sx={{
              ...
              <TextField fullWidth label="Markup" value="0%" sx={{ mb: 2 }} />
              <Button
                variant="contained"
                fullWidth
                sx={{
