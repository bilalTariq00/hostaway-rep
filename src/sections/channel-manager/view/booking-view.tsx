...
import { Info, Plus, Save, Search, XCircle, Settings, ArrowLeft, RefreshCw, CheckCircle, ExternalLink } from 'lucide-react';
    ...
    <DashboardContent maxWidth="xl">
        ...
        <Box sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', mb: 3 }}>
          ...
          <Box sx={{ display: 'flex', gap: 2 }}>
            <Button
              ...
              onClick={() => setLegalEntityModalOpen(true)}
      ...
      >
        ...
        <DialogContent sx={{ px: 4, py: 2 }}>
          <Box sx={{ mt: 2 }}>
            ...
            <Box sx={{ display: 'flex', alignItems: 'flex-start', gap: 2, mb: 3 }}>
              <Box sx={{ display: 'flex', gap: 1, mt: 0.5 }}>
                <Box sx={{ width: 20, height: 20, borderRadius: 1, bgcolor: '#FFD700', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
            ...
            <Box sx={{ display: 'flex', alignItems: 'flex-start', gap: 2, mb: 3 }}>
              <Box sx={{ display: 'flex', gap: 1, mt: 0.5 }}>
                <Box sx={{ width: 20, height: 20, borderRadius: 1, bgcolor: '#607D8B', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
                  <Typography variant="caption" sx={{ fontSize: '0.7rem', color: 'white' }}>🏢</Typography>
                </Box>
                <Box sx={{ width: 20, height: 20, borderRadius: 1, bgcolor: '#607D8B', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
                  <Typography variant="caption" sx={{ fontSize: '0.7rem', color: 'white' }}>🏢</Typography>
        ...
        <DialogActions sx={{ p: 4, gap: 2, justifyContent: 'center' }}>
          ...
          <Button 
            ...
            onClick={() => {
              ...
              setPropertyIdModalOpen(true);
            }}
            sx={{ 
              textTransform: 'none', 
              bgcolor: agreedToTerms ? '#003580' : '#E0E0E0',
              color: agreedToTerms ? 'white' : '#999',
              px: 3,
              py: 1,
              borderRadius: 2,
              '&:hover': {
                bgcolor: agreedToTerms ? '#002A5C' : '#E0E0E0',
              }
            }}
          >
            Next
      ...
      >
        <DialogTitle sx={{ pb: 1 }}>
          ...
          <Typography variant="body2" color="text.secondary" sx={{ textAlign: 'center', lineHeight: 1.6 }}>
            Please provide the required legal entity information for Booking.com integration.
          </Typography>
        </DialogTitle>
        <DialogContent sx={{ px: 4, py: 2 }}>
          <Box sx={{ mt: 2 }}>
            <Box sx={{ display: 'flex', alignItems: 'flex-start', gap: 2, mb: 3 }}>
              ...
              <Typography variant="body2" sx={{ lineHeight: 1.5 }}>
                Provide your legal entity information and documentation for Booking.com compliance.
              </Typography>
            </Box>
            <Box sx={{ display: 'flex', alignItems: 'flex-start', gap: 2, mb: 3 }}>
              <Box sx={{ 
              ...
              <Typography variant="body2" sx={{ lineHeight: 1.5 }}>
                Review and verify all legal documentation before submission.
              </Typography>
            </Box>
            <Box sx={{ display: 'flex', alignItems: 'flex-start', gap: 2, mb: 3 }}>
              <Box sx={{ 
              ...
              <Typography variant="body2" sx={{ lineHeight: 1.5 }}>
                Ensure all financial information and billing details are accurate.
              </Typography>
            </Box>
          </Box>
      ...
      >
        ...
        <DialogActions sx={{ p: 3, gap: 2, justifyContent: 'flex-end' }}>
          <Button 
            onClick={() => setPropertyIdModalOpen(false)}
            sx={{ 
              textTransform: 'none', 
              color: '#00A699',
              bgcolor: '#F0F9F8',
          ...
          <>
            ...
            <Box sx={{ mb: 4 }}>
              ...
              <Button 
                variant="contained" 
                fullWidth 
                sx={{ textTransform: 'none', bgcolor: '#00A699', mb: 3 }}
              >
                Save
              </Button>
