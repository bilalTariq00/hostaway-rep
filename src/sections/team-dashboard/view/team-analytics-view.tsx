...
export function TeamAnalyticsView() {
  ...
  const recentBookings = [
    { id: 1, guest: 'Sarah Johnson', property: 'Downtown Loft', checkIn: '2024-01-15', status: 'confirmed', amount: '$245' },
    { id: 2, guest: 'Mike Chen', property: 'Beach House', checkIn: '2024-01-16', status: 'pending', amount: '$189' },
    { id: 3, guest: 'Emily Davis', property: 'Mountain Cabin', checkIn: '2024-01-17', status: 'confirmed', amount: '$156' },
    { id: 4, guest: 'David Wilson', property: 'City Apartment', checkIn: '2024-01-18', status: 'cancelled', amount: '$98' },
    { id: 5, guest: 'Lisa Brown', property: 'Lakeside Villa', checkIn: '2024-01-19', status: 'confirmed', amount: '$312' }
  ];
          ...
          <Card 
            ...
            sx={{ 
              ...
              '&::before': {
                ...
                right: 0,
                bottom: 0,
                background: 'radial-gradient(circle at 1px 1px, rgba(0,0,0,0.1) 0.5px, transparent 0.5px)',
            ...
            <Box sx={{ position: 'relative', width: 200, height: 200 }}>
              ...
              <svg width="200" height="200" viewBox="0 0 200 200" style={{ position: 'relative', zIndex: 1 }}>
                {pieChartData.map((segment, index) => {
                  const startAngle = pieChartData.slice(0, index).reduce((acc, item) => acc + (item.value / 100) * 360, 0);
              ...
              <Box sx={{ 
                ...
                <Typography variant="h4" sx={{ fontWeight: 700, color: 'text.primary', mb: 0.5, lineHeight: 1 }}>
                  100%
                </Typography>
            ...
            <Box sx={{ height: 200, display: 'flex', alignItems: 'end', gap: 1, px: 1 }}>
              {barChartData.map((data, index) => (
                <Box key={index} sx={{ flex: 1, display: 'flex', flexDirection: 'column', alignItems: 'center', gap: 0.5 }}>
                  <Box sx={{ display: 'flex', flexDirection: 'column', gap: 0.5, height: 150, justifyContent: 'end', width: '100%' }}>
                    <Box sx={{ 
                      width: '100%', 
