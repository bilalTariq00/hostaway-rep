...
export function TeamDashboardPage() {
  ...
  const newestBookings = [
    {
      ...
      guests: '3-5 guests',
      price: '$83.74',
      image: 'https://pub-c5e31b5cdafb419fb247a8ac2e78df7a.r2.dev/public/assets/images/mock/travel/travel-1.webp',
      avatar: 'JS'
    },
    {
      id: 2,
      ...
      guests: '2-4 guests',
      price: '$97.14',
      image: 'https://pub-c5e31b5cdafb419fb247a8ac2e78df7a.r2.dev/public/assets/images/mock/travel/travel-2.webp',
      avatar: 'LO'
    },
    {
      id: 3,
  ...
  const customerReviews = [
    ...
    },
    {
      ...
      rating: 5.0,
      review: 'Amazing experience! The team was professional and the service exceeded my expectations. Highly recommended for anyone looking for quality.',
    ...
    },
    {
      ...
      rating: 4.0,
      review: 'Good service overall. The process was smooth and the team was responsive. Would definitely use again in the future.',
    ...
    },
    {
      ...
      rating: 4.8,
      review: 'Outstanding customer support and quick turnaround time. The quality of work was exceptional and met all our requirements perfectly.',
      ...
      <Box sx={{ display: 'grid', gridTemplateColumns: { xs: '1fr', md: 'repeat(3, 1fr)' }, gap: 3, mb: 4 }}>
        ...
        <Card sx={{ p: 3, position: 'relative', overflow: 'hidden' }}>
          <Box sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', mb: 2 }}>
            ...
            <Box sx={{ width: 130, height: 130, borderRadius: 2, display: 'flex', alignItems: 'center', justifyContent: 'center', overflow: 'hidden' }}>
              <img 
        ...
        <Box sx={{ display: 'grid', gridTemplateColumns: { xs: '1fr', md: 'repeat(2, 1fr)' }, gap: 3 }} >
            ...
            <Card sx={{ 
              ...
              '&::before': {
                ...
                right: 0,
                bottom: 0,
                background: 'radial-gradient(circle at 1px 1px, rgba(200,250,214,0.2) 0.5px, transparent 0.5px)',
              ...
              '&::after': {
                ...
                right: 0,
                bottom: 0,
                background: 'radial-gradient(circle at 6px 6px, rgba(200,250,214,0.1) 0.3px, transparent 0.3px)',
              ...
              <Box sx={{ position: 'relative', zIndex: 1 }}>
                <Box sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', mb: 3 }}>
                  <Typography variant="h6" sx={{ color: '#C8FAD6', fontWeight: 500, fontSize: '1rem' }}>
                    Total incomes
                  </Typography>
                  <Box sx={{ display: 'flex', flexDirection: 'column', alignItems: 'flex-end' }}>
                    <Box sx={{ display: 'flex', alignItems: 'center', gap: 0.5, mb: 0.5 }}>
                      <TrendingUp size={16} color="#C8FAD6" />
                      <Typography variant="body2" sx={{ color: '#C8FAD6', fontWeight: 600, fontSize: '0.875rem' }}>
                        {statsData.totalIncomes.change}
                      </Typography>
                    </Box>
                    <Typography variant="caption" sx={{ color: 'rgba(200,250,214,0.8)', fontSize: '0.75rem' }}>
                      last month
                    </Typography>
                  </Box>
                </Box>
                <Typography variant="h2" sx={{ fontWeight: 700, mb: 4, color: '#C8FAD6', fontSize: '2.75rem' }}>
                  ...
                  <svg width="100%" height="100%" viewBox="0 0 300 80" preserveAspectRatio="none">
                    ...
                    <defs>
                      <pattern id="grid" width="30" height="20" patternUnits="userSpaceOnUse">
                        <path d="M 30 0 L 0 0 0 20" fill="none" stroke="rgba(200,250,214,0.15)" strokeWidth="0.5"/>
                      </pattern>
                    </defs>
        ...
        <Card sx={{ p: 3, position: 'relative', overflow: 'hidden' }}>
          ...
          <Box sx={{ position: 'relative', zIndex: 1 }}>
            ...
            <Box sx={{ display: 'flex', gap: 2, mb: 3 }}>
              ...
              <Typography variant="body2" color="text.secondary">Canceled</Typography>
            </Box>
              ...
              {[
                ...
                <Box key={index} sx={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: 1, flex: 1 }}>
                  <Box sx={{ display: 'flex', gap: 0.5, alignItems: 'end', height: 150 }}>
                    <Box sx={{ width: 20, height: `${data.sold}%`, bgcolor: '#4CAF50', borderRadius: 1 }} />
                    <Box sx={{ width: 20, height: `${data.canceled}%`, bgcolor: '#F8BBD9', borderRadius: 1 }} />
                  </Box>
                </Box>
              ))}
            </Box>
          ...
          {Array.from({ length: Math.ceil(newestBookings.length / 4) }).map((_, index) => (
            <Box
              ...
              sx={{
                ...
                height: 8,
                borderRadius: '50%',
                bgcolor: index === Math.floor(currentBookingIndex / 4) ? 'primary.main' : 'grey.300',
                cursor: 'pointer',
                transition: 'background-color 0.2s'
              }}
