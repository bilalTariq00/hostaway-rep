...
import { teamNavData } from '../nav-config-team';
...
export type TeamDashboardLayoutProps = LayoutBaseProps & {
...
function TeamDashboardLayoutContent({
    ...
    const headerSlots: HeaderSectionProps['slots'] = {
      topArea: (
        <Alert severity="info" sx={{ display: 'none', borderRadius: 0 }}>
          Team Dashboard - Manage your team operations
        </Alert>
      ),
      leftArea: (
        <>
          ...
          <NavMobile data={teamNavData} open={open} onClose={onClose} workspaces={_workspaces} />
        </>
      ),
      rightArea: (
  ...
  return (
    <LayoutSection
       ...
       *************************************** */
      sidebarSection={
        <NavDesktop data={teamNavData} layoutQuery={layoutQuery} workspaces={_workspaces} />
      }
      /** **************************************
       * @Footer
       *************************************** */
...
export function TeamDashboardLayout(props: TeamDashboardLayoutProps) {
  return (
    <SidebarProvider>
      <TeamDashboardLayoutContent {...props} />
    </SidebarProvider>
  );
}
